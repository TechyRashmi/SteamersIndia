...
public class AllotedRequest extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DrawerActivity.tvHeaderText.setText("Alloted Requests");
    ...
    public void replaceFragmentWithAnimation(Fragment fragment,String array,String complaint_no,String Material) {
        ...
        public void onBindViewHolder(@NonNull final Holder holder, final int position) {
            ...
            holder.llmain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    replaceFragmentWithAnimation(new FinishTaskFragment(),data.get(position).getComplaintarray(),data.get(position).getComplaintno(),data.get(position).getMaterial_required());
                }
            });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        if((object.getString("customer_approved").equalsIgnoreCase("yes"))&&(object.getString("status").equalsIgnoreCase("pending")))
                        {
                            ...
                            techmodel.setMaterial_required(object.getString("material_required"));
                    ...
                    {
                        Toasty.warning(getActivity(), "No Alloted request found", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
